...
func (m *mcpServer) tools() []mcp.Tool {
	...
	tools := []mcp.Tool{
		...
		{
			Name:        "docs",
			Description: "Format reference for writing sources: model, texture, material, scene, prefab, world, map, scenario, api, lua (also project, vda, inspect, config, 2d, and the guides for people start-windows and first-game).",
