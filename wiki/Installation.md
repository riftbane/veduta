...
It must print a `v2` version (`v2.0.0-rc.7` or later). Running the same two lines again
...
| `$env:VEDUTA_VERSION` | an exact version, such as `v2.0.0-rc.7` |
...
```sh
go install -ldflags "-X main.version=v2.0.0-rc.7" github.com/riftbane/veduta/v2/cmd/veduta@v2.0.0-rc.7
```
