...
It must print a `v2` version (`v2.0.0-rc.5` or later). Running the same two lines again
...
| `$env:VEDUTA_VERSION` | an exact version, such as `v2.0.0-rc.5` |
...
```sh
go install -ldflags "-X main.version=v2.0.0-rc.5" github.com/riftbane/veduta/v2/cmd/veduta@v2.0.0-rc.5
```
