...
func TestMetaCanonical(t *testing.T) {
	...
	want := `{"compiler":"veduta-asset/0.4.0","deps":["textures/src/a&b<c>.png","textures/src/b.png"],"kind":"material","name":"crate_wood","source":"materials/crate_wood.mat.json","source_hash":"` + testHash + `"}`
